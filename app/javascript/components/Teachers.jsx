...
class Teachers extends React.Component {
  ...
  allTeachers(filter) {
    ...
    const teachersLanguage = teachers.filter(
      teacher => teacher.language === filter
    );
  ...
  filterWrap() {
    ...
    const rateFilter = this.allTeachersRates(
      languageFilter,
      this.props.filterRate
    );
    return rateFilter;
  }
    ...
    return (
      <>
        <section className="GoTalk-BgAndColor jumbotron jumbotron-fluid text-center">
          <nav className="main-navbar d-flex flex-column flex-wrap">
            <div>
              <p className="btn custom-button nav-links">
            ...
            <div>
              <p>
                <Link
                  ...
                  className="btn custom-button nav-links"
                >
                  Upcoming lessons
                </Link>
              </p>
          ...
          <div className="container py-5">
            ...
            <p className="lead text-muted">Some of the available teachers</p>
          </div>
        </section>
        <div className="py-5">
          <main className="container">
            ...
            <div className="row">
              {teachers.length > 0
                ? this.mapTeachers(this.filterWrap())
                : noTeachers}
            </div>
